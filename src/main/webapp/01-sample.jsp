...
<!-- 
	...
	+ 부트스트랩에서 구성된 화면에는 항상 최외곽에 
	  .container 혹은 .container.fluid 클래스 속성이 적용된 div가 위치해야 한다.
	+ 부트스트랩에서 제공하는 그리드시스템(레이아웃 구성을 지원한다.)이 정상적으로 적용되기 위해서 필요하다.
 -->
	<div class="container">
		부트스트랩은 모바일 기기를 우선으로 개발하기 때문에 모바일 기기에 최적화하기 위해 모든 모바일 장치에 화면이 올바르게 랜더링되고, 터치 확대 조절을 보장하기 위해서 헤드태그에 메타태그로 viewport 메타태그를 추가한다.
	  	부트스트랩은 모바일 기기를 우선으로 개발하기 때문에 모바일 기기에 최적화하기 위해 모든 모바일 장치에 화면이 올바르게 랜더링되고, 터치 확대 조절을 보장하기 위해서 헤드태그에 메타태그로 viewport 메타태그를 추가한다.
	  	부트스트랩은 모바일 기기를 우선으로 개발하기 때문에 모바일 기기에 최적화하기 위해 모든 모바일 장치에 화면이 올바르게 랜더링되고, 터치 확대 조절을 보장하기 위해서 헤드태그에 메타태그로 viewport 메타태그를 추가한다.
	  	부트스트랩은 모바일 기기를 우선으로 개발하기 때문에 모바일 기기에 최적화하기 위해 모든 모바일 장치에 화면이 올바르게 랜더링되고, 터치 확대 조절을 보장하기 위해서 헤드태그에 메타태그로 viewport 메타태그를 추가한다.
	  	부트스트랩은 모바일 기기를 우선으로 개발하기 때문에 모바일 기기에 최적화하기 위해 모든 모바일 장치에 화면이 올바르게 랜더링되고, 터치 확대 조절을 보장하기 위해서 헤드태그에 메타태그로 viewport 메타태그를 추가한다.
