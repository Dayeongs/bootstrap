	...
	<div class="row">
		<div class="col-12">
			...
			<div class="mb-3">
				...
				<a href="" class="btn btn-danger btn-sm">수정</a>
				<input type="button" class="btn btn-warning btn-sm" value="버튼">
				<input type="reset" class="btn btn-danger btn-sm" value="리셋">
				<input type="submit" class="btn btn-success btn-sm" value="제출">
			</div>
			<div class="mb-3">
				<!-- 
					...
					<a> 링크의 비활성화
						.disabled를 추가한다.
						area-disabled="true"를 추가한다.
						tabindex="-1"를 추가한다. 
						<a href="" class="btn btn-primary disabled">링크</a>
						
				 -->
				<button class="btn btn-primary btn-sm" disabled>버튼</button>
